...
1. Generates a realistic random Pakistani user using your own knowledge of common Pakistani names across regions:
   - Name: a realistic Pakistani first + last name
   - Email: derived from the name with a random 2-3 digit 
     number suffix (e.g. asif.shahzad91@gmail.com)
